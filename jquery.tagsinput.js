...
(function($) {
	...
	$.fn.tagsInput = function(options) { 
		...
		var settings = jQuery.extend({interactive:true,defaultText:'add a tag',minChars:0,width:'300px',height:'100px','hide':true,'delimiter':',',autocomplete:{autoFocus:true},'unique':true,removeWithBackspace:true},options);
		this.each(function() { 
			if (settings.hide) { 
				$(this).hide();				
			}
